...
class PedidoRepository:
    ...
    def get_pedidos_report_excel(fecha_inicio, fecha_fin):
        connection = get_connection()
        query, params = PedidoRepository.get_report_query("SELECT * FROM pedidos", "fecha_creacion", fecha_inicio, fecha_fin)
    ...
    def get_pedidos_report_pdf(fecha_inicio, fecha_fin):
        ...
        base_query = """
            ...
            JOIN clientes ON pedidos.cliente_id = clientes.id
        """
        query, params = PedidoRepository.get_report_query(base_query, "pedidos.fecha_creacion", fecha_inicio, fecha_fin)
        cursor.execute(query, params)
